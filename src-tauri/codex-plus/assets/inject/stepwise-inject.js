(() => {
  ...
  function toggleCodexTheme() {
    ...
    setCodexThemeMode(nextTheme)
      ...
      .catch((error) => {
        console.warn("[Codex_Plus Stepwise] Failed to switch Codex theme", error);
      });
  }
  ...
  function statusLine(settings) {
    if (settings.enabled !== true) return "Stepwise 已关闭，请在 Codex_Plus Manager 里开启。";
  ...
  async function openManager() {
    state.settingsStatus = "正在打开 Codex_Plus Manager...";
    renderFloat();
